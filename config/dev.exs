...
config :tide, TideWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "8UuIvj3esk5066pmjD1EYZenB34yBNdoD2J9PUuqGXk9W14xrUgiKbP/uhHKiEO9",
  watchers: [
...
config :tide, TideWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/tide_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :tide, dev_routes: true
